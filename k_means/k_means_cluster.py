...
##print scaler.transform([[float(0), float(200000), float(1000000)]])
...
##    if data_dict[key]["exercised_stock_options"] > max_exercised_stock_options and data_dict[key]["exercised_stock_options"] != "NaN":
...
##for key in data_dict:
##    if data_dict[key]["exercised_stock_options"] < min_exercised_stock_options and data_dict[key]["exercised_stock_options"] != "NaN":
...
##max_salary = 0
##for key in data_dict:
##    if data_dict[key]["salary"] > max_salary and data_dict[key]["salary"] != "NaN":
...
##for key in data_dict:
##    if data_dict[key]["salary"] < min_salary and data_dict[key]["salary"] != "NaN":
